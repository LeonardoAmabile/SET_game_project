...
def train_dnn(tables, num_sets, num_cards, num_attributes, num_tables):
    """Train a deep neural network to predict the number of SETs in a table.
    """
...
def test_dnn(model, tables, num_sets, num_random=10000):
    """Tests the trained model on random tables
    """

    tables, num_sets, num_cards, num_attributes, num_tables = process('Testing_dataset.txt')
...
_description = 'Deep Neural Network'
...
if __name__ == '__main__':
    ...
    if args.infile == './Training_dataset.txt' or args.infile == 'Training_dataset.txt':
        test_dnn(model, tables, num_sets)
